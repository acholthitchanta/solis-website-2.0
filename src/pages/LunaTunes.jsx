...
export default function LunaTunes() {
  ...
  return (
    <div ref={containerRef}>
      <Landing theme="dark-blue" background="db" landingImg={lunatunes} title={"LUNATUNES"} description={"Our online therapeudic music program brings uplifting music to patients upon request."} />
      ...
      <div className="lunatunes-row dark-blue lunatunes-row-padded">
        <div className="lunatunes-row-inner">
          <div className="lunatunes-media lunatunes-media-desktop-only">
            <div className="lunatunes-circle-wrap">
              <img src={lunatunes2} alt="Solis members rehearsing" />
            </div>
          </div>
          <div className="lunatunes-text">
      ...
      <div className="lunatunes-row light-blue lunatunes-row-padded">
        <div className="lunatunes-row-inner">
          <div className="lunatunes-media">
            <div className="lunatunes-video-wrap">
              <iframe
